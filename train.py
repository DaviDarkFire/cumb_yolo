...
def _main():
    #annotation_path_train = 'train.txt'
    #annotation_path_val = 'val.txt'
    #log_dir = 'logs/000/'

    annotation_path_train = sys.argv[1]
    annotation_path_val = sys.argv[2]
    log_dir = sys.argv[3]
    classes_path = 'model_data/cumbaru_classes.txt'
...
#    np.random.seed(None)
    ...
    if False:
        ...
        model.load_weights(os.path.join(log_dir + 'trained_weights_stage_1.h5'))
