...
class YOLO(object):
    _defaults = {
        "model_path": 'model_data/ep632-loss13.462-val_loss15.186.h5',
    ...
    def detect_image(self, image, txtpath=None):
        start = timer()
...
obj = YOLO()
obj.detect_image("img/1.JPG","img/1.txt")
